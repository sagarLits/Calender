...
public class CalenderEventController {
	...
	// ✅ Update Event
	@PutMapping("/{id}")
	public ResponseEntity<CalenderEvent> updateEvent(@PathVariable("id") String id, @RequestBody CalenderEvent event) {
	...
	@GetMapping("/search")
	public ResponseEntity<List<CalenderEvent>> getEventsByMonthAndYear(@RequestParam("year") int year,
